...
<head>
    ...
    <title>Clerk Certificates</title>
</head>
<style>
        .table_section {
            height: 650px;
...
<div class="container">
    ...
    <div class="searchBar">
        <form action="" method="post">
            ...
            <?php echo "\t \t"; ?>
            <a href="clerk_homepage.php" class="backBtn">Back</a>
        ...
        <tbody>
            ...
            <?php if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["AppliedFor"] . "</td>";

                    echo "<td>";

                    ?>
                    <form method="post">
                        <a href="generateCertificate.php?stud_id=<?php echo $row['reg_id']; ?>&appFor=<?php echo $row['AppliedFor']; ?>"><button type="button"
                                name="changestatus">Generate Certificate</button></a></td>
                    </form>
                    <?php
                    echo "</td>";
        ...
        while ($rowSearch = $searchResult->fetch_assoc()) {
            ...
            <table>
                ...
                <tbody>
                    ...
                    echo "<td>" . $rowSearch["AppliedFor"] . "</td>";

                    echo "<td>";

                    ?>
                    <form method="post">
                        <a href="generateCertificate.php?stud_id=<?php echo $rowSearch['reg_id']; ?>&appFor=<?php echo $rowSearch['AppliedFor']; ?>"><button type="button"
                                name="changestatus">Generate Certificate</button></a></td>
                    </form>
                    <?php
                    echo "</td>";
