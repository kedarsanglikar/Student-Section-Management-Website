...
<br><br>
                <center><div class="certificate-div">
                 

                
                <?php
                $reg=$_SESSION['regId'];
                $selectQuery="select * from certificates where reg_Id='$reg';";
                ...
                if(mysqli_num_rows($result) > 0){
                    ...
                    <form action="" method="post">
                        <input type="submit" value="Get requested Document" name="getDocument" class="getDocument" style="padding: 10px 20px; font-size: 16px; border-radius: 5px; Background-color: #8bd7ff;" >
                    </form>
...
if(!empty($_POST['getDocument'])){
    ...
    if ($result->num_rows > 0) {
        while ($rowSearch = $result->fetch_assoc()) {
            ...
            $pdf->cell(20,10,"This is to certify that Mr./Miss/Mrs. ".$rowSearch['StudentName']);
            $pdf->Ln();
        
            $pdf->cell(20,10,"is/was a bonafide student of this college studying in");
            $pdf->Ln();
        
            $pdf->cell(20,10,$rowSearch['Class']." class with roll No. ".$rowSearch['RollNo']." in the year");
            $pdf->Ln();
        
            $pdf->cell(20,10,$rowSearch['Year']." his/her birth date is ".$rowSearch['DateOfBirth']." his/her Aadhar");
            $pdf->Ln();
        
            $pdf->cell(20,10,"Card/UIDAI No. ".$rowSearch['AadharNo']." and his/her caste is ");
            $pdf->Ln();

            $pdf->cell(20,10,$rowSearch['Religion']." as per our General Register and his/her");
            $pdf->Ln();
            ...
            $pdf->cell(20,10,"Purpose ".$rowSearch['Purpose']);
            $pdf->Ln();
